...
#define ANT_CHANNEL_PERIOD_LO_USERAPP   (u8)0x06              // LO; 0x0001 - 0x7fff
#define ANT_CHANNEL_PERIOD_HI_USERAPP   (u8)0x58              // HI; 0x0001 - 0x7fff
#define ANT_DEVICEID_LO_USERAPP         (u8)0x77              // Device # Low byte
#define ANT_DEVICEID_HI_USERAPP         (u8)0x77              // Device # High byte
#define ANT_DEVICE_TYPE_USERAPP         (u8)1                 // 1 - 255
#define ANT_TRANSMISSION_TYPE_USERAPP   (u8)1                 // 1-127; MSB is pairing
#define ANT_FREQUENCY_USERAPP           (u8)30                // 2400MHz + 0 - 99 MHz
...
void UserApp1SM_AntChannelAssign(void);
